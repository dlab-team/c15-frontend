    ...
    <main className='flex container'>
      ...
      <div className='lg:w-[50%] p-10 w-[100%] flex flex-col items-center justify-center'>
        ...
        <form className='flex flex-col w-[100%]'>
          ...
          <a href="#" className='lg:w-[70%] m-auto mb-5 text-end text-[var(--blue)] underline'>¿Olvidaste tu contraseña?</a>
          ...
          <div className='w-[70%] flex flex-col items-center lg:flex-row m-auto justify-between mt-10'>
            ...
            <a href="#" className='text-[var(--blue)] underline'>Crea una cuenta</a>
          </div>
        </form>
      </div>
    </main>
